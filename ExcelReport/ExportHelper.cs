...
namespace ExcelReport
{
    public static class ExportHelper
    {
        ...
        /// <param name="targetFile"></param>
        /// <param name="sheetFormatters"></param>
        public static void ExportToLocal(Stream ExcelStream, string targetFile, params SheetFormatter[] sheetFormatters)
        {
            #region 参数验证
            ...
            {
                throw new FileNotFoundException(ExcelStream + " 不存在!");
            }
            ...
            using (FileStream fs = File.OpenWrite(targetFile))
            {
                byte[] buffer = Export.ExportToBuffer(ExcelStream, sheetFormatters);
                fs.Write(buffer, 0, buffer.Length);
                fs.Flush();
            }
        }
